              ...
              <div key={`${post.user?.username}-${currentIndex}`} className="bg-white rounded-lg shadow-sm border border-border">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <p className="text-sm text-text-secondary">@{currentPost.user?.username || 'unknown'}</p>
                      </button>
                    </div>
                  </div>
                ...
                <div className="px-4 pb-4">
                  {currentPost.content?.image && (
                    <div className="mb-4">
                      <div className="w-full h-64 bg-border-light rounded-lg flex items-center justify-center mb-4 relative">
                        <img 
                  ...
                  <p className="text-text-primary mb-3">{currentPost.content?.text || currentPost.content}</p>
                  ...
                  <div className="flex items-center space-x-6">
                    ...
                    >
                      <Heart 
                        size={20} 
                        className={likedPosts.has(currentPost.id) ? 'fill-like text-like' : ''} 
                      />
                      <span className="text-sm">{currentPost.engagement?.likes || 0}</span>
                    </button>
                    
                    <button 
                      onClick={() => handleComment(currentPost)}
                      className="flex items-center space-x-2 hover:text-comment transition-colors"
                    >
                      <MessageCircle size={20} />
                      <span className="text-sm">{currentPost.engagement?.comments || 0}</span>
                    </button>
                  ...
                  {userPosts.length > 1 && (
                    <div className="mt-4 flex items-center justify-between">
                      <button
                        ...
                        className="p-2 hover:bg-border-light rounded-full transition-colors disabled:opacity-50"
                      >
                        <ChevronLeft size={20} />
                      </button>
