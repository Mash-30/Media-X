    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-500 to-primary-600 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-primary-100">Sign in to continue to Media X</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-12 py-3 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                  required
                />
                <button
                  type="button"
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={socialLoading}
              className="w-full flex items-center justify-center space-x-3 bg-white text-text-primary border border-border py-3 px-4 rounded-lg hover:bg-border-light transition-colors disabled:opacity-50"
            >
